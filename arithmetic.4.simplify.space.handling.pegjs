...
EXP_AS
  = val1:EXP_PD PLUS_  val2:EXP_AS { return val1 + val2; }
  / val1:EXP_PD MINUS_ val2:EXP_AS { return val1 - val2; }
  / val1:EXP_PD { return val1; }

EXP_PD
  = val1:EXP_X MULT_ val2:EXP_PD { return val1 * val2; }
  / val1:EXP_X DIV_  val2:EXP_PD { return val1 / val2; }
