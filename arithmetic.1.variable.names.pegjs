...
  / _ "TRUE"i _ "(" _ ")" _ { return true; }
 ...
  / _ "POWER"i _ "(" _ val1:EXPR _ "," _ val2:EXPR _ ")" _ { return Number(val1) ** Number(val2); }
  / _ "ROUND"i _ "(" _ val1:EXPR _ "," _ val2:EXPR _ ")" _ { return myRound(val1, val2); }
  / _ "LOG10"i _ "(" _ val1:EXPR _ ")" _ { return Math.log10(Number(val1)); }
  / _ "LOG"i _ "(" _ val1:EXPR _ "," _ val2:EXPR _ ")" _ { return myLog(val1, val2); }
  / _ "LN"i _ "(" _ val1:EXPR _ ")" _ { return Math.log(Number(val1)); }
