...
*/
  ...
  / ! { return EXCEL_STYLE; } val1:VALUE CARET_ val2:EXP_X  { return val1 ** val2; }
  / ! { return EXCEL_STYLE; } val1:VALUE { return val1; }


VALUE
  = MINUS_ & { return EXCEL_STYLE; } val:VALUE  { return -val; }
  / MINUS_ ! { return EXCEL_STYLE; } val:EXP_X  { return -val; }
